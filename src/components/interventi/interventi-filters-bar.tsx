...
import { INTERVENTO_STATO_OPTIONS } from "@/lib/intervento-status";

const ALL_STATI = "tutti";

export function InterventiFiltersBar() {
  ...
  const hasFilters = q || stato !== ALL_STATI || from || to;
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end">
      <div className="flex min-w-56 flex-1 flex-col gap-1.5">
        ...
        <Input
          placeholder="Nome intervento, luogo o ticket..."
          value={q}
